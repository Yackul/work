...
class ReviewCreator extends React.Component {
    ...
    handleClick1() {
        axios.post('https://ec2-35-164-105-133.us-west-2.compute.amazonaws.com/min_diff', {
    ...
    handleClick2() {
        axios.post('https://ec2-35-164-105-133.us-west-2.compute.amazonaws.com/full_diff', {
            repoPath: this.state.packageFile,
            fileName: this.state.fileName
        })
            .then((response) => {
