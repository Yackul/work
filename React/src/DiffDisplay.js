...
class DiffDisplay extends React.Component {
    ...
    componentDidMount = async () => {
        ...
        for (var j = 0; j < this.state.commList.length; j++) {
            ...
            this.state.commentDict[this.state.commList[x].COMMENTINDEX].push(<div><Comment PID={this.props.PID}
                                                                                           FID={this.props.FID}
                                                                                           isOpen={true}
